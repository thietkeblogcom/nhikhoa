...
{$('body').off('uabb-trigger.'+hook,callback);},};})(jQuery);jQuery(document).ready(function($){var uabb_browser=bowser.name,uabb_browser_v=bowser.version,uabb_browser_class=uabb_browser.replace(/\s+/g,'-').toLowerCase(),uabb_browser_v_class=uabb_browser_class+parseInt(uabb_browser_v);$('html').addClass(uabb_browser_class).addClass(uabb_browser_v_class);});var wpAjaxUrl='http://6982.webthongminh.info/wp-admin/admin-ajax.php';var flBuilderUrl='http://6982.webthongminh.info/wp-content/plugins/bb-plugin/';var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'http://6982.webthongminh.info/wp-content/plugins/bb-plugin/',wpAjaxUrl:'http://6982.webthongminh.info/wp-admin/admin-ajax.php'}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);(function($,window,undefined){$(window).load(function(){$('.uabb-ih-container').css({'visibility':'visible','opacity':1});});$(document).ready(function(){uabb_ihover_init();$(document).ajaxComplete(function(e,xhr,settings){uabb_ihover_init();});});$(window).resize(function(){uabb_ihover_init();});function uabb_ihover_init(){$('.uabb-ih-list').each(function(index,el){var s=$(el).attr('data-shape');var h=$(el).attr('data-height');var w=$(el).attr('data-width');var rh=$(el).attr('data-res_height');var rw=$(el).attr('data-res_width');var ww=jQuery(window).width()||'';$(el).find('li').each(function(){$(el).find('.uabb-ih-item').addClass('uabb-ih-'+s);});});}
if(!/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent))
var is_touch_device=false;else
var is_touch_device=true;jQuery('#page').click(function(){jQuery('.uabb-ih-hover').removeClass('uabb-ih-hover');});if(!is_touch_device){jQuery('.uabb-ih-item').hover(function(event){jQuery(this).addClass('uabb-ih-hover');},function(event){event.stopPropagation();jQuery(this).removeClass('uabb-ih-hover');});}else{jQuery('.uabb-ih-item').click(function(event){if(jQuery(this).hasClass('uabb-ih-hover')){jQuery(this).removeClass('uabb-ih-hover');}
else{jQuery('.uabb-ih-hover').removeClass('uabb-ih-hover');jQuery(this).addClass('uabb-ih-hover');}});}}(jQuery,window));